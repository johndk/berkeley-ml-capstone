...
This appendix records the experiments that have been completed. [Appendix D](Appendix-D.md) describes the plan;
Appendix E shows what was actually run and the results. Separate tables record the model setup, the quality of its rankings and probabilities,
